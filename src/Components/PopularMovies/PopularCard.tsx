...
type Props = { movie: Movie; movieHovered: Function; movieLeaved: Function; addMovie: Function,addPopular:Function }

export default function PopularCard({ movie, movieHovered, movieLeaved,addPopular }: Props) {
  const [attention, setAttention] = useState(false)
  const [loading, setLoading] = useState(false)
  const [stored, setStored] = useState(movie.owned)
  const openAttention = () => {
    setAttention(true)
    movieHovered()
  }
